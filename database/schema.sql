...
-- ---------------------------------------------------------------
-- TABELA: configuracoes_studio
-- Dados institucionais e convite de avaliação Google.
-- ---------------------------------------------------------------
CREATE TABLE IF NOT EXISTS configuracoes_studio (
    id TINYINT UNSIGNED NOT NULL PRIMARY KEY,
    nome_studio VARCHAR(160) NOT NULL,
    endereco VARCHAR(255) NOT NULL,
    telefone VARCHAR(30) NOT NULL,
    instagram VARCHAR(255) NULL,
    facebook VARCHAR(255) NULL,
    link_localizacao TEXT NULL,
    horario_funcionamento TEXT NULL,
    logo_path VARCHAR(255) NULL,
    ativar_convite_google TINYINT(1) NOT NULL DEFAULT 1,
    texto_convite_google VARCHAR(255) NOT NULL,
    link_avaliacao_google TEXT NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO configuracoes_studio (
    ...
    1,
    'Studio Bruna Nayara',
    'Quadra 87 - Centro, Santo Antônio do Descoberto - GO, 72900-198',
    '(61) 99176-7582',
    'https://www.instagram.com/studiobrunanayaraa/',
    'https://www.facebook.com/studiobrunanayaraa/',
    'https://www.google.com/local/place/fid/0x935bdbf1b17eeec3:0xf2b3f01421c882dc/photosphere?iu=https://streetviewpixels-pa.googleapis.com/v1/thumbnail?panoid%3DX3pNbm2l5L2X2sLRMd9exg%26cb_client%3Dsearch.gws-prod.gps%26yaw%3D33.494884%26pitch%3D0%26thumbfov%3D100%26w%3D0%26h%3D0&ik=CAISFlgzcE5ibTJsNUwyWDJzTFJNZDlleGc%3D&sa=X&ved=2ahUKEwj8ttepuoyTAxUIlZUCHXKwMwoQpx96BAhIEBI',
...
domingo: Fechado',
    NULL,
    1,
    'Gostou do nosso atendimento? Sua avaliação no Google é muito importante para o Studio Bruna Nayara.',
    'https://g.page/r/CdyCyCEU8LOyEBM/review'
)
ON DUPLICATE KEY UPDATE nome_studio = VALUES(nome_studio), endereco = VALUES(endereco), telefone = VALUES(telefone);
...
-- Migração de compatibilidade (caso a tabela já exista sem logo_path)
ALTER TABLE configuracoes_studio
