                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-end gap-1 flex-wrap">
                            ...
                            <form method="post" action="/servicos/status" class="m-0">
                                <?= csrf_field() ?>
                            ...
                            <form method="post" action="/servicos/excluir" class="m-0" onsubmit="return confirm('Excluir logicamente este serviço?')">
                                <?= csrf_field() ?>
                                <input type="hidden" name="id" value="<?= (int) $service['id'] ?>">
