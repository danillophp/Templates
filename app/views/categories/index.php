                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-end gap-1 flex-wrap">
                            ...
                            <form method="post" action="/categorias/status" class="m-0">
                                <?= csrf_field() ?>
                            ...
                            <form method="post" action="/categorias/excluir" class="m-0" onsubmit="return confirm('Excluir logicamente esta categoria?')">
                                <?= csrf_field() ?>
                                <input type="hidden" name="id" value="<?= (int) $category['id'] ?>">
