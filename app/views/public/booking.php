    ...
    <div class="col-lg-10">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form method="post" action="/agendamento/reservar" id="booking-form" class="row g-3">
                    <?= csrf_field() ?>
...
(() => {
    ...
    async function loadTimes() {
        ...
        try {
            const res = await fetch(`/api/agenda/horarios-disponiveis?data=${encodeURIComponent(date)}&servico_id=${encodeURIComponent(serviceId)}`);
