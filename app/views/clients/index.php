...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body">
        <form method="get" action="/clientes" class="row g-2 align-items-end">
            <div class="col-md-4">
            ...
            <div class="col-auto">
                <a class="btn btn-outline-secondary" href="/clientes">Limpar</a>
            </div>
        </form>
    </div>
</div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-end gap-1 flex-wrap">
                            <a href="/clientes/historico?id=<?= (int) $client['id'] ?>" class="btn btn-outline-info btn-sm">Histórico</a>
                            <a href="/clientes/editar?id=<?= (int) $client['id'] ?>" class="btn btn-outline-secondary btn-sm">Editar</a>
                            <form method="post" action="/clientes/excluir" class="m-0" onsubmit="return confirm('Remover cliente?')">
                                <?= csrf_field() ?>
