...
<div class="row g-3 mb-3">
  <?php foreach ($summary as $k => $v): ?>
    <div class="col-6 col-lg-3">
      <div class="card shadow-sm"><div class="card-body"><small><?= $k ?></small><h3><?= $v ?></h3></div></div>
    </div>
  <?php endforeach; ?>
</div>
...
<div class="card shadow-sm mb-3">
  <div class="card-body">
    ...
    <small class="text-muted d-block mt-2">Pontos ativos: <?= count($points) ?></small>
  </div>
</div>
...
<div class="card shadow-sm"><div class="table-responsive"><table class="table table-sm align-middle mb-0"><thead><tr><th>#</th><th>Nome</th><th>Endereço</th><th>Data</th><th>Status</th><th>Ações</th></tr></thead><tbody id="reqRows"></tbody></table></div></div>
